...
export default () => (
  ...
  >
    ...
    <trace from=".J_XIAO_RIGHT > .D8_SCK_GPIO2_AIN1" to=".J_DRV8833_LEFT > .AIN1" />
    <trace from=".J_XIAO_RIGHT > .D10_MOSI_GPIO3_AIN2" to=".J_DRV8833_LEFT > .AIN2" />
    <trace from=".J_XIAO_RIGHT > .D9_MISO_GPIO4_SLEEP" to=".J_DRV8833_LEFT > .SLEEP" />
    <trace from=".J_XIAO_RIGHT > .D7_RX_GPIO1_FAULT" to=".J_DRV8833_LEFT > .FAULT" />
